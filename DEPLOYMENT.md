...
| URL | Meaning |
|---|---|
| `.../reqmesh/v0.2.3/scripts/install.sh` | that release — reproducible, recommended |
...
```bash
tar xzf reqmesh-v0.2.3.tar.gz && cd reqmesh-v0.2.3
...
```bash
docker load < reqmesh-v0.2.3-image.tar.gz
