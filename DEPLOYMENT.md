...
| URL | Meaning |
|---|---|
| `.../reqmesh/v0.1.21/scripts/install.sh` | that release — reproducible, recommended |
...
```bash
curl -fsSL https://raw.githubusercontent.com/CallumNunesVaz/reqmesh/v0.1.21/scripts/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/CallumNunesVaz/reqmesh/v0.1.21/scripts/install.sh \
...
```bash
tar xzf reqmesh-v0.1.21.tar.gz && cd reqmesh-v0.1.21
...
```bash
docker load < reqmesh-v0.1.21-image.tar.gz
