...
| URL | Meaning |
|---|---|
| `.../reqmesh/v0.6.1/scripts/install.sh` | that release — reproducible, recommended |
...
```bash
tar xzf reqmesh-v0.6.1.tar.gz && cd reqmesh-v0.6.1
...
```bash
docker load < reqmesh-v0.6.1-image.tar.gz
