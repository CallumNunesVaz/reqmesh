...
| URL | Meaning |
|---|---|
| `.../reqmesh/v0.2.6/scripts/install.sh` | that release — reproducible, recommended |
...
```bash
tar xzf reqmesh-v0.2.6.tar.gz && cd reqmesh-v0.2.6
...
```bash
docker load < reqmesh-v0.2.6-image.tar.gz
