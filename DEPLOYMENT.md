...
| URL | Meaning |
|---|---|
| `.../reqmesh/v0.3.0/scripts/install.sh` | that release — reproducible, recommended |
...
```bash
tar xzf reqmesh-v0.3.0.tar.gz && cd reqmesh-v0.3.0
...
```bash
docker load < reqmesh-v0.3.0-image.tar.gz
