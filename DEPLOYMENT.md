...
| URL | Meaning |
|---|---|
| `.../reqmesh/v0.3.7/scripts/install.sh` | that release — reproducible, recommended |
...
```bash
tar xzf reqmesh-v0.3.7.tar.gz && cd reqmesh-v0.3.7
...
```bash
docker load < reqmesh-v0.3.7-image.tar.gz
