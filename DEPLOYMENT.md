...
| URL | Meaning |
|---|---|
| `.../reqmesh/v0.1.36/scripts/install.sh` | that release — reproducible, recommended |
...
```bash
tar xzf reqmesh-v0.1.36.tar.gz && cd reqmesh-v0.1.36
...
```bash
docker load < reqmesh-v0.1.36-image.tar.gz
