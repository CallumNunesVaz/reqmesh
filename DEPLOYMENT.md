...
| URL | Meaning |
|---|---|
| `.../reqmesh/v0.3.1/scripts/install.sh` | that release — reproducible, recommended |
...
```bash
tar xzf reqmesh-v0.3.1.tar.gz && cd reqmesh-v0.3.1
...
```bash
docker load < reqmesh-v0.3.1-image.tar.gz
