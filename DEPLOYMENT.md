...
| URL | Meaning |
|---|---|
| `.../reqmesh/v0.2.4/scripts/install.sh` | that release — reproducible, recommended |
...
```bash
tar xzf reqmesh-v0.2.4.tar.gz && cd reqmesh-v0.2.4
...
```bash
docker load < reqmesh-v0.2.4-image.tar.gz
