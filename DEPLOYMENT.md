...
| URL | Meaning |
|---|---|
| `.../reqmesh/v0.3.5/scripts/install.sh` | that release — reproducible, recommended |
...
```bash
tar xzf reqmesh-v0.3.5.tar.gz && cd reqmesh-v0.3.5
...
```bash
docker load < reqmesh-v0.3.5-image.tar.gz
