...
│   ├── tests/             # 1415 integration + unit tests (pytest)
...
**Backend** — 1415 tests covering API, storage, auth, integrity, quality, tracing, code scan, fingerprint, table I/O, evaluation, what-if impact, and deployment:
...
```bash
curl -fsSL https://raw.githubusercontent.com/CallumNunesVaz/reqmesh/v0.2.0/scripts/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/CallumNunesVaz/reqmesh/v0.2.0/scripts/install.sh \
