...
[bulk operations](docs/api.md#bulk-operations) section of the API reference.
...
```bash
curl -fsSL https://raw.githubusercontent.com/CallumNunesVaz/reqmesh/v0.2.5/scripts/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/CallumNunesVaz/reqmesh/v0.2.5/scripts/install.sh \
...
**[docs/api.md](docs/api.md)**. It is generated rather than hand-written, so it
