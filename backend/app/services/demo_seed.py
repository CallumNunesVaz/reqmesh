...
from app.services.naming import DEFAULT_NAMING
...
# budget rollups (`rollup('C172', 'mass')`, `rollup('AVIO01', 'current')`) have
...
COMPONENTS = [
    ...
    _comp("CODT01", "Active CO Detector", "part", "SAFE01",
...
SPECIFICATIONS = [
    {"id": "SPEC-SYS", "name": "System Requirements Specification",
     ...
     "requirements": ["ACFT0000", "AFRM0000", "PROP0000", "AVNC0000",
                      ...
                      "SAFE0000"],
     "components": ["FUSE01", "WING01", "EMP01", "GEAR01", "ENG01", "PRPL01", "FUEL01",
                     "AVIO01", "ELEC01", "FLTC01", "ENVR01", "SAFE01"],
     "children": ["SPEC-AVIO"]},
    {"id": "SPEC-AVIO", "name": "Avionics Subsystem Specification",
     ...
     "requirements": ["AVNC0001", "AVNC0002", "AVNC0003", "AVNC0004",
                      ...
                      "AVNC0009", "AVNC0010"],
     "components": ["GDU01", "GIA01", "GDC01", "GRS01", "GMU01", "GEA01", "GTX01", "GMA01"],
     "children": []},
]
...
CHANGE_REQUESTS = [
    {"id": "CR000001", "title": "Evaluate Lycoming IO-390 Upgrade",
     ...
     "affected_components": ["ENG01", "PRPL01"],
    ...
    {"id": "CR000003", "title": "LED Exterior Lighting Retrofit",
     ...
     "affected_components": ["NAVL01", "TAIL01", "BCON01", "STRB01", "TAXI01"],
...
RISKS = [
    ...
    {"id": "RSK00001", "title": "Engine Failure on Takeoff",
     ...
     "linked_components": ["ENG01"],
     "mitigating_components": ["LMAG01", "RMAG01"]},
    {"id": "RSK00002", "title": "Fuel Exhaustion in Flight",
     ...
     "linked_components": ["TANK01", "FQSND01"],
     "mitigating_components": ["GDU01"]},
    ...
    {"id": "RSK00004", "title": "Carbon Monoxide Incapacitation",
     ...
     "linked_components": ["MUFF01", "SHUD01"],
     "mitigating_components": ["CODT01"]},
    {"id": "RSK00005", "title": "Alternator Failure in IMC",
     ...
     "linked_components": ["ALT01"],
     "mitigating_components": ["BATT01", "EBUS01"]},
    {"id": "RSK00006", "title": "Icing Encounter",
     ...
     "linked_components": ["WING01", "EMP01"]},
]
...
COMMENTS = [
    ...
    {"id": "gen-009", "author": "Structures Engineer",
     "entity_kind": "components", "entity_id": "SPAR01",
...
DECISIONS = [
    {"id": "DEC0001", "title": "Avionics Platform Selection",
     ...
     "linked_components": ["GDU01", "GIA01", "GDC01", "GRS01", "GMU01", "GEA01", "GTX01", "GMA01"],
    ...
    {"id": "DEC0002", "title": "Engine Selection",
     ...
     "linked_components": ["ENG01", "FISV01", "FDIV01", "LMAG01", "RMAG01"],
    ...
    {"id": "DEC0003", "title": "Lighting Technology — LED vs Halogen",
     ...
     "linked_components": ["NAVL01", "TAIL01", "BCON01", "STRB01", "TAXI01"],
    ...
    {"id": "DEC0004", "title": "Fixed Tricycle Landing Gear",
     ...
     "linked_components": ["GEAR01", "MLEG01", "NLEG01", "SMDM01"],
     "status": "accepted", "decided_by": "Chief Engineer"},
    {"id": "DEC0005", "title": "28 V Electrical System Architecture",
     ...
     "linked_components": ["ALT01", "BATT01", "EBUS01", "MBUS01"],
     "status": "accepted", "decided_by": "Electrical Systems"},
    {"id": "DEC0006", "title": "Fuel Capacity — 53 US Gallons",
     ...
     "linked_components": ["TANK01", "FQSND01", "FUEL01", "FSEL01"],
    ...
    {"id": "DEC0007", "title": "McCauley 1A170/E Fixed-Pitch Propeller",
     ...
     "linked_components": ["PRPL01", "SPIN01"],
     "status": "accepted", "decided_by": "Powerplant Lead"},
    {"id": "DEC0008", "title": "High-Wing Configuration",
     ...
     "linked_components": ["WING01", "STRT01", "SPAR01", "ASPAR01"],
     "status": "accepted", "decided_by": "Chief Engineer"},
]
...
def seed_demo_project(data_root: Path, force: bool = False) -> bool:
    ...
    store.write_meta({
        "name": PROJECT_NAME,
        "created": "",
        # The naming standards the seeded ids follow, written explicitly rather
        # than left to defaults so the demo shows the feature configured. Every
        # seeded id satisfies this scheme (see test_demo_seed / test_naming),
        # and enforcement is on — the example demonstrates the standard, not a
        # project grandfathered out of it.
        "naming": {**DEFAULT_NAMING, "enforce": True},
    ...
    reqs["ELEC0001"]["constraints"] = [
        {"expr": "rollup('AVIO01', 'current') <= continuous_load_limit",
         "assume": None}]
    ...
    store.write_item("analysis_cases", "cold-weather-ops", {
        ...
        "scope": ["ENVR0001"],
        "scope_components": ["SHUD01", "ENVR01"],
