...
non_interactive() {
    ...
    save_cfg "GIT_COMMIT_SCHEDULE" "${RT_GIT_COMMIT_SCHEDULE:-every_change}"
    save_cfg "GIT_COMMIT_INTERVAL_HOURS" "${RT_GIT_COMMIT_INTERVAL_HOURS:-0}"
    save_cfg "GIT_COMMIT_CHANGES_THRESHOLD" "${RT_GIT_COMMIT_CHANGES_THRESHOLD:-0}"
